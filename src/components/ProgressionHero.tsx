  ...
  if (!hasPair) {
    return (
      <div className={`mt-4 rounded-2xl border p-4 ${tone}`}>
        ...
        <p className="mt-2 text-sm font-medium text-slate-900">The instrument needs a second reading</p>
  ...
  return (
    <div className={`mt-4 rounded-2xl border p-4 ${tone}`}>
      ...
      <div className="mt-3 grid grid-cols-3 gap-2 text-center">
        <div>
          <p className="text-2xl font-semibold tabular-nums text-slate-900">{firstPct}%</p>
          <p className="mt-1 text-[10px] uppercase tracking-wider text-slate-500">First</p>
        </div>
        <div className="flex items-center justify-center">
          <span className="text-slate-400">→</span>
        </div>
        <div>
          <p className="text-2xl font-semibold tabular-nums text-slate-900">{latestPct}%</p>
          <p className="mt-1 text-[10px] uppercase tracking-wider text-slate-500">Latest</p>
        </div>
      </div>
      <p
