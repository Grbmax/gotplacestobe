  ...
  return (
    <div id="legal-evidence" className="print-root hidden print:block">
      <header className="border-b border-zinc-300 pb-3">
        <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500">SCAN · Legal evidence packet</p>
      ...
      <section className="mt-6 rounded border border-zinc-400 p-3">
        ...
        <p className="mt-2 text-xs text-zinc-700">
          I certify that these photographs and overlays were captured in SCAN and have not been
