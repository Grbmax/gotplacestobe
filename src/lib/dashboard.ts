  ...
  tiles.push({
    ...
    read:
      around?.level === "elevated" || around?.level === "watch"
        ? "This is a neighborhood health signal among children who were tested — not a blood test of this household or the people next door. Combined with peeling paint in an older house, SCAN treats paint failure as a high lead-hazard priority."
